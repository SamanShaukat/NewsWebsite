...
class LatestPosts extends AbstractBlock {
	...
	public function render( $attributes, $content, $block ) {
		...
		$posts      = $this->get_latest_posts_by_category( $categories );
	 ...
	 * @return array
	 */
	protected function get_latest_posts_by_category( $categories ) {
		$latest_posts    = array();
		$displayed_posts = array();

		foreach ( $categories as $category ) {
			$latest_post = $this->get_latest_post_in_category( $category->term_id );
	 ...
	 * @return mixed
	 */
	protected function get_latest_post_in_category( $category_id ) {
